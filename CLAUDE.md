...
| File                    | Class        | Methods                                                                |
| ----------------------- | ------------ | ---------------------------------------------------------------------- |
| `string.rb`             | String       | `to_boolean`, `titleize_place`*, `titleize_name`*                      |
...
*`titleize_place` and `titleize_name` require ActiveSupport
...
- `File.normalize_last_line` shells out to the `uchardet` CLI binary for encoding detection. Install via `brew install uchardet` (or distro equivalent).
